...
/*EVENTS*/
DELIMITER $$
CREATE DEFINER=root@localhost EVENT take_snapshot ON SCHEDULE EVERY 10 MINUTE STARTS '1980-05-10 00:00:00' ENDS '2050-05-10 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
